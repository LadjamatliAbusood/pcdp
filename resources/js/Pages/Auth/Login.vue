...
<template>
  <main class="flex flex-col md:flex-row h-screen w-screen">
    ...
    <!-- Login Form -->
    <section class="flex flex-col justify-center items-center w-full md:w-1/2 bg-white px-6 md:px-16 relative">

      <div class="absolute top-4 left-4 md:top-6 md:left-6">
        <img src="/public/storage/imgs/dswd_bagong_pilipinas_logo.svg" class="h-10 md:h-14" />
      </div>
    ...
    <!-- Right Image/Quote -->
    <section class="hidden md:flex items-center justify-center w-1/2 h-full bg-white p-5">
      <div class="relative w-full h-[80%] rounded-2xl overflow-hidden shadow-lg">
        <img src="/public/storage/imgs/bg-dswd.jpg" class="object-cover w-full h-full brightness-50" />
