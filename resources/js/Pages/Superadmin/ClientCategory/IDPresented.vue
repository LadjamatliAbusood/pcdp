...
const label = computed(() => editingClient.value ? 'Update Identification Card' : 'Add Identification Card');
...
const editClient = (client) => {
    ...
    form.id_presented = client.id_presented;
...
const submit = () => {
    ...
    const routeName = isEdit
        ? route('client-idpresented.update', editingClient.value.id)
        : route('client-idpresented.store');
        ...
        <DataTable
            ...
            class="p-datatable-sm text-sm min-w-[600px]"
             removableSort
                ...
                scrollHeight="flex"
        >
            <Column field="id_presented" header="Identification Card">
                <template #body="slotProps">
                    <span class="text-sm text-gray-800">
                        {{ slotProps.data.id_presented }}
                    </span>
                </template>
            </Column>
